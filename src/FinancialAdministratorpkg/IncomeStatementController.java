...
public class IncomeStatementController implements Initializable {
    ...
    @FXML
    private TextField softwareCostTextfield;
    @FXML
    private TextField cyberSecurityTextfield;
    ...
    private void calculateTotalExpensesButton(MouseEvent event) {
        ...
        double contentAcquisition = Double.parseDouble(cyberSecurityTextfield.getText());
        double marketingCost = Double.parseDouble(softwareCostTextfield.getText());
    ...
    double defaultCyberSecurity = Double.parseDouble(cyberSecurityTextfield.getText());;
    double defaultSoftwareCost = Double.parseDouble(softwareCostTextfield.getText());;
    
    FinancialAdministrator.addIncomeData(month,defaultSalaryAndWages ,defaultRentAndUtilities , expenses, revenue,defaultCyberSecurity , defaultSoftwareCost, netProfit, netLoss);
    }
