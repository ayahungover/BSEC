...
import FinancialAdministratorpkg.FinancialAdministrator;
import FinancialAdministratorpkg.License;
import FinancialAdministratorpkg.LicenseDetailsController;
import java.io.File;
...
public class LicenseNContractController implements Initializable {
    ...
    @FXML
    private void seeDescriptionOnClick(ActionEvent event) throws IOException {
    ...
    @FXML
    private void addLicenseOnClick(ActionEvent event) {
        int x=0;
        ...
        if(FinancialAdministrator.isAlpha(s[i])==false){
            z=1;
        }}if(z==1){
            Alert a = new Alert(Alert.AlertType.INFORMATION);
            a.setTitle("Information Alert");
